...
import { Form15Data, Form15InputData, } from '@/components/taxDocument/template/Form15/types';
...
type Form15Props = UpdaterProps<Form15Data> & { inputType?: Form15InputData };

export default function Form15({ updater, inputType, ...data }: Form15Props) {
      ...
      <div className="form-15">
              ...
              <tr style={{ height: '16pt' }}>
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.baseTotalAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.basePlannedAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.currentPurchaseAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.deductibleTargetAmt}
                  />
                </td>
              </tr>
            </table>
              ...
              <tr style={{ height: '16pt' }}>
                ...
                >
                  <Input
                    ...
                    inputType={inputType?.deductionRate}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.deductibleTaxAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.preDeductedTotal}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.preDeductedPlanned}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.preDeductedEarly}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.finalDeductibleTax}
                  />
                </td>
              </tr>
            </table>
              ...
              <tr style={{ height: '16pt' }}>
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufBaseTotal}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufBaseTerm1}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufBaseTerm2}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <Input
                    ...
                    inputType={inputType?.manufLimitRate}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufLimitAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPurchaseTotal}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPurchaseTerm1}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPurchaseTerm2}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufTargetAmt}
                  />
                </td>
              </tr>
            </table>
              ...
              <tr style={{ height: '16pt' }}>
                ...
                >
                  <Input
                    ...
                    inputType={inputType?.manufDeductionRate}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufDeductibleTaxAmt}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPreDedTotal}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPreDedTerm1}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPreDedTerm2Total}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    onChange={value =>
                      updater('manufPreDedTerm2Planned', value)
                    }
                    style={{
                      width: 'calc(100% - 2pt)',
                      height: 'calc(100% - 2pt)',
                    }}
                    inputType={inputType?.manufPreDedTerm2Planned}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    inputType={inputType?.manufPreDedTerm2Early}
                  />
                </td>
                <td
                  style={{
                ...
                >
                  <NumericInput
                    ...
                    onChange={value =>
                      updater('manufFinalDeductibleTax', value)
                    }
                    style={{
                      width: 'calc(100% - 2pt)',
                      height: 'calc(100% - 2pt)',
                    }}
                    inputType={inputType?.manufFinalDeductibleTax}
                  />
                </td>
              </tr>
            </table>
          ...
          <tr style={{ height: '15pt' }}>
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.farmerPurchaseTotalCount}
              />
            </td>
            <td
              style={{
            ...
            >
              <Input
                ...
                onChange={value =>
                  updater('farmerPurchaseTotalItemName', value)
                }
                style={{
                  width: 'calc(100% - 2pt)',
                  height: 'calc(100% - 2pt)',
                }}
                inputType={inputType?.farmerPurchaseTotalItemName}
              />
            </td>
            <td
              style={{
            ...
            >
              <NumericInput
                ...
                onChange={value =>
                  updater('farmerPurchaseTotalQuantity', value)
                }
                style={{
                  width: 'calc(100% - 2pt)',
                  height: 'calc(100% - 2pt)',
                }}
                inputType={inputType?.farmerPurchaseTotalQuantity}
              />
            </td>
            <td
              style={{
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.farmerPurchaseTotalAmt}
              />
            </td>
          </tr>
            ...
            <tr key={`farmer-item-${index}`} style={{ height: '15pt' }}>
              ...
              >
                <Input
                  ...
                  inputType={
                    inputType?.farmerPurchaseItems?.[index]?.sellerName
                  }
                />
              </td>
              <td
              ...
              >
                <Input
                  ...
                  inputType={
                    inputType?.farmerPurchaseItems?.[index]?.sellerResNumber
                  }
                />
              </td>
              <td
              ...
              >
                <NumericInput
                  ...
                  onChange={value =>
                    farmerItemUpdater(index, 'itemCount', value)
                  }
                  style={{
                    width: 'calc(100% - 2pt)',
                    height: 'calc(100% - 2pt)',
                  }}
                  inputType={inputType?.farmerPurchaseItems?.[index]?.itemCount}
                />
              </td>
              <td
                style={{
              ...
              >
                <Input
                  value={item.itemName}
                  onChange={value =>
                    farmerItemUpdater(index, 'itemName', value)
                  }
                  style={{
                    width: 'calc(100% - 2pt)',
                    height: 'calc(100% - 2pt)',
                  }}
                  inputType={inputType?.farmerPurchaseItems?.[index]?.itemName}
                />
              </td>
              <td
                style={{
              ...
              >
                <NumericInput
                  value={item.quantity}
                  onChange={value =>
                    farmerItemUpdater(index, 'quantity', value)
                  }
                  style={{
                    width: 'calc(100% - 2pt)',
                    height: 'calc(100% - 2pt)',
                  }}
                  inputType={inputType?.farmerPurchaseItems?.[index]?.quantity}
                />
              </td>
              <td
                style={{
              ...
              >
                <NumericInput
                  ...
                  inputType={
                    inputType?.farmerPurchaseItems?.[index]?.purchasePrice
                  }
                />
              </td>
            </tr>
        ...
        >
          <Input
            ...
            onChange={value =>
              updater('writeYear', value.replace(/[^0-9]/g, ''))
            }
            style={{
              width: '25pt',
              height: '18pt',
        ...
        >
          ...
          />
          <Stamp className="s13">(서명 또는 인)</Stamp>
        </p>
        <h1
          style={{
            paddingTop: '2pt',
