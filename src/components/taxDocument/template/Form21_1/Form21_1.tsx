    ...
    <div className="form21_1">
        ...
        <tr>
          ...
          >
            ...
            >
              ...
              >
                [
                <input type="checkbox" name="reportType" id="check3" />] 기한후
                과세표준
              ...
              >
                [
                <input type="checkbox" name="reportType" id="check4" />] 영세율
                등 조기환급
              </p>
            </div>
          </td>
      ...
      >
        <colgroup>
          ...
          <col style={{ width: '25pt' }}></col>
          <col style={{ width: '161pt' }}></col>
          <col style={{ width: '25pt' }}></col>
          <col style={{ width: '161pt' }}></col>
          <col style={{ width: '40pt' }}></col>
          <col style={{ width: '171pt' }}></col>
        </colgroup>
        <tr style={{ height: '15pt' }}>
          <td
            style={{
