'use client';
import 'src/components/taxDocument/template/Form19/pages/Form19_3/form19_3.css';
...
export default function Form19_3({
  ...
  const startIndex =
    FORM19_1_REPAYMENT_ITEM_LENGTH + index * FORM19_3_REPAYMENT_ITEM_LENGTH;
  const mappedRepaymentTaxItems: (repaymentTaxItem | null)[] = Array.from(
    { length: FORM19_3_REPAYMENT_ITEM_LENGTH },
    (_, i) => repaymentTaxItems[startIndex + i] ?? null
  );
      ...
      >
        <tr style={{ height: '23pt' }}>
          ...
          >
            ...
            >
              ⑯<span className="s6">변제</span>
              <br />
              <span className="s6">금액</span>
            </p>
          </td>
          <td
            style={{
          ...
          >
            ...
            >
              ⑰<span className="s6">공제율</span>
              <br />
              <span className="s6">(10/110)</span>
            </p>
          </td>
          <td
            style={{
        ...
        <tr style={{ height: '27pt' }}>
          ...
          >
            ...
            >
              ㉑<span className="s6">사업자등록번호</span>
            </p>
          </td>
        </tr>
        {mappedRepaymentTaxItems.map((item, itemIndex) => (
          <tr style={{ height: '25pt' }} key={`repayment-${itemIndex}`}>
            <td
              className="table-cell"
              style={{
                width: '55pt',
            ...
            >
              <Input
                ...
                onChange={value =>
                  repaymentItemUpdater(itemIndex, 'deductionRate', value)
                }
              />
            </td>
            <td
