...
export default function Form47_2() {
  return (
    <div className="form47_2">
      <ul id="l1">
        <li data-list-text="■">
          <p style={{ paddingTop: '3pt', paddingLeft: '17pt', textIndent: '-9pt', textAlign: 'left' }}>
            부가가치세법 시행규칙 [별지 제47호서식(2)]
          </p>
        </li>
      </ul>
      <p className="s1" style={{ paddingTop: '6pt', paddingLeft: '11pt', textIndent: '0pt', textAlign: 'center', fontFamily: 'HY견고딕, sans-serif' }}>
        동물진료용역매출대장
        <span className="s2" style={{ fontFamily: 'HY견고딕, sans-serif' }}>
          (을)
        </span>
      </p>
      <h1 style={{ paddingTop: '5pt', paddingBottom: '1pt', paddingLeft: '12pt', textIndent: '0pt', textAlign: 'center' }}>
      ...
      <table style={{ borderCollapse: 'collapse', marginLeft: '431pt', marginRight: '10pt', width: '441pt' }} cellSpacing="0">
        <tr style={{ height: '20pt' }}>
          <td style={{ width: '130pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#ADADAD', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#ADADAD', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#ADADAD', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#ADADAD', textAlign: 'center', verticalAlign: 'middle', display: 'table-cell', position: 'relative', padding: '1pt' }}>
            <p className="s3" style={{ padding: '0', paddingBottom: '0', textIndent: '0pt', textAlign: 'center', verticalAlign: 'middle', margin: '0', lineHeight: '20pt', display: 'inline-block' }}>
              사업자등록번호
            </p>
            <input className="form-input form-input-text" style={{ width: 'calc(100% - 152pt)', height: '18pt', padding: '1.5pt', verticalAlign: 'middle', position: 'absolute', right: '1pt', top: '50%', transform: 'translateY(-50%)' }} type="text" />
          </td>
          <td style={{ width: '311pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#ADADAD', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#ADADAD', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#ADADAD', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#ADADAD', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-text" style={{ width: 'calc(100% - 2pt)', height: '18pt', padding: '1.5pt' }} type="text" />
          </td>
        </tr>
      </table>
      <table style={{ borderCollapse: 'collapse', marginLeft: '5.297pt', marginTop: '15pt', width: '882pt' }} cellSpacing="0">
        <tr style={{ height: '20pt' }}>
          <td style={{ width: '37pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '0', textAlign: 'center', verticalAlign: 'middle' }} rowSpan="2">
          ...
          <td style={{ width: '192pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '0', textAlign: 'center', verticalAlign: 'middle' }} colSpan="3">
            <p className="s4" style={{ padding: '0', textIndent: '0pt', lineHeight: '11pt', textAlign: 'center', verticalAlign: 'middle' }}>
              공급받은 자
            </p>
          </td>
          <td style={{ width: '57pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', padding: '0', textAlign: 'center', verticalAlign: 'middle' }} rowSpan="2">
            <p className="s4" style={{ padding: '0', textIndent: '0pt', textAlign: 'center', verticalAlign: 'middle' }}>
              ⑭ 비고
            </p>
          </td>
        ...
        <tr style={{ height: '20pt' }}>
          ...
          <td style={{ width: '80pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '0', textAlign: 'center', verticalAlign: 'middle' }}>
            <p className="s5" style={{ padding: '0', textIndent: '0pt', lineHeight: '11pt', textAlign: 'center', verticalAlign: 'middle' }}>
              ⑫ 주민등록번호
            </p>
          </td>
        ...
        <tr style={{ height: '20pt' }}>
          <td style={{ width: '37pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '1pt', verticalAlign: 'middle' }}>
          ...
          <td style={{ width: '57pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderBottomColor: '#787878', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-text" style={{ width: '100%', height: 'calc(100% + 2pt)', padding: '1pt' }} type="text" />
          </td>
        </tr>
        <tr style={{ height: '20pt' }}>
        ...
        <tr style={{ height: '20pt' }}>
          <td style={{ width: '37pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-date" style={{ width: '100%', height: 'calc(100% + 2pt)', padding: '1pt' }} type="text" />
          </td>
          ...
          <td style={{ width: '80pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-text" style={{ width: '100%', height: 'calc(100% + 2pt)', padding: '1pt' }} type="text" />
          </td>
          <td style={{ width: '54pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', borderRightStyle: 'solid', borderRightWidth: '1pt', borderRightColor: '#787878', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-text" style={{ width: '100%', height: 'calc(100% + 2pt)', padding: '1pt' }} type="text" />
          </td>
          <td style={{ width: '57pt', borderTopStyle: 'solid', borderTopWidth: '1pt', borderTopColor: '#787878', borderLeftStyle: 'solid', borderLeftWidth: '1pt', borderLeftColor: '#787878', borderBottomStyle: 'solid', borderBottomWidth: '1pt', padding: '1pt', verticalAlign: 'middle' }}>
            <input className="form-input form-input-text" style={{ width: '100%', height: 'calc(100% + 2pt)', padding: '1pt' }} type="text" />
          </td>
        </tr>
      </table>
      ...
      <hr style={{ width: '882pt', border: 'none', borderTop: '1pt solid #000', margin: '0', padding: '0' }} />
      <h2 style={{ textIndent: '0pt', lineHeight: '11pt', textAlign: 'center' }}>
        작 성 방 법
      </h2>
      <p style={{ textIndent: '0pt', textAlign: 'left' }}>
      </p>
      <p style={{ paddingTop: '4pt', paddingBottom: '4pt', textIndent: '0pt', textAlign: 'center' }}>
        이 서식은 『동물 진료용역 매출대장(갑)』
        <span className="s6">
          [별지 제47호서식(1)]
        </span>
        을 초과하는 매출분이 있는 경우 작성합니다.
      </p>
      <hr style={{ width: '882pt', border: 'none', borderTop: '1pt solid #000', margin: '0', padding: '0' }} />
