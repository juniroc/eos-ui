...
export default function Form38_1({
  ...
  const startIndex = pageIndex * FORM_38_1_MAX_DETAIL_LIST_MAX_LENGTH;
  const detailItems = Array.from(
    { length: FORM_38_1_MAX_DETAIL_LIST_MAX_LENGTH },
  ...
  const getSummaryRow = (rowKey: SummaryRowKey) => {
    switch (rowKey) {
      ...
      case 'electronicIssuedBiz':
        return summary.electronicTaxInvoice.issuedToBizRegNumber;
      case 'electronicIssuedResident':
        return summary.electronicTaxInvoice.issuedToResidentRegNumber;
      case 'electronicSubTotal':
        return summary.electronicTaxInvoice.subTotal;
      case 'nonElectronicIssuedBiz':
        return summary.nonElectronicTaxInvoice.issuedToBizRegNumber;
      case 'nonElectronicIssuedResident':
        return summary.nonElectronicTaxInvoice.issuedToResidentRegNumber;
    ...
    switch (rowKey) {
      ...
      case 'electronicIssuedBiz':
        next.electronicTaxInvoice = {
          ...
          issuedToBizRegNumber: updaterFn(
            summary.electronicTaxInvoice.issuedToBizRegNumber
          ),
        };
        break;
      case 'electronicIssuedResident':
        next.electronicTaxInvoice = {
          ...summary.electronicTaxInvoice,
          issuedToResidentRegNumber: updaterFn(
            summary.electronicTaxInvoice.issuedToResidentRegNumber
          ),
        };
        break;
      case 'electronicSubTotal':
      ...
      case 'nonElectronicIssuedBiz':
        next.nonElectronicTaxInvoice = {
          ...
          issuedToBizRegNumber: updaterFn(
            summary.nonElectronicTaxInvoice.issuedToBizRegNumber
          ),
        };
        break;
      case 'nonElectronicIssuedResident':
        next.nonElectronicTaxInvoice = {
          ...summary.nonElectronicTaxInvoice,
          issuedToResidentRegNumber: updaterFn(
            summary.nonElectronicTaxInvoice.issuedToResidentRegNumber
          ),
        };
        break;
      case 'nonElectronicSubTotal':
  ...
  const updateSummarySplit = (
    ...
    part: keyof Form38Data['summary']['grandTotal']['supplyPrice'],
    value: number
  ) => {
    updateSummaryRow(rowKey, row => ({
      ...row,
  ...
  const updateSubmitterInfo = (
    field: keyof Form38Data['submitterInfo'],
    value: string
  ) => {
