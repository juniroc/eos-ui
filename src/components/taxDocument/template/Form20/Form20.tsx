...
type Form20Props = UpdaterProps<Form20Data> & { inputType?: Form20InputData };

export type Props = Form20Data & Form20Props & { inputType?: Form20InputData };
  ...
  return (
    <PageSlot slotWidth={624} slotHeight={882}>
      <div className="form20">
                    ...
                    >
                      ...
                      >
                        <YesNoSelector
                          ...
                          onChange={value =>
                            updater('isUnder300Million', value)
                          }
                          inputStyle={{
                            width: '18pt',
                            height: '18pt',
                          ...
                          inputType={inputType?.isUnder300Million}
                        />
                      </p>
                    </td>
                  </tr>
          ...
          <tr style={{ height: '26pt' }}>
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.issuanceCount}
              />
            </td>
            <td
              style={{
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.calculableTaxAmount}
              />
            </td>
            <td
              style={{
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.finalDeductionAmount}
              />
            </td>
          </tr>
        </table>
          ...
          <tr style={{ height: '29pt' }}>
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.alreadyDeductedAmount}
              />
            </td>
            <td
              style={{
            ...
            >
              <NumericInput
                ...
                inputType={inputType?.periodDeductionLimit}
              />
            </td>
          </tr>
        </table>
        ...
        <p
          style={{ paddingLeft: '12pt', textIndent: '0pt', textAlign: 'left' }}
        >
          「부가가치세법」 제47조에 따라 전자세금계산서 발급세액공제를 받기
          위하여 위와 같이 신고합니다.
        </p>
        <p
          className="s1"
        ...
        >
          ...
          <Input
            ...
            value={writeDay}
            onChange={value =>
              updater('writeDay', value.replace(/[^0-9]/g, ''))
            }
        ...
        >
          ...
          />
          <Stamp className="s7">(서명 또는 인)</Stamp>
        </p>
        <h1
          style={{
            paddingTop: '0pt',
