  ...
  return (
    <div className="form21_2">
      ...
      >
        <tr style={{ height: '116pt' }}>
          ...
          >
            ...
            >
              5. 대손세액 공제(변제)신고서와 대손사실 또는 변제사실을 증명하는
              서류
            </p>
            <p
              className="s2"
            ...
            >
              11. 부동산임대공급가액명세서 및 임대계약서 사본(사업장을 임대한 후
              임대차계약을 갱신한 경우에만 첨부합니다)
            </p>
            <p
              className="s2"
              style={{
            ...
            <ol id="l1">
              ...
              <li data-list-text="14.">
                ...
                >
                  사업장별 부가가치세 과세표준 및 납부세액(환급세액)
                  신고명세서(주사업장 총괄납부를 하는 경우만 첨부합니다)
                </p>
              </li>
              <li data-list-text="15.">
                ...
                >
                  사업자 단위 과세의 사업장별 부가가치세 과세표준 및
                  납부세액(환급세액) 신고명세서(사업자 단위 과세자인 경우만
                  첨부합니다)
                </p>
              </li>
              <li data-list-text="16.">
                ...
                >
                  <span>건물 등 감가상각자산 취득명세서</span>
                  <span
                    style={{ position: 'absolute', left: '189pt', top: '0' }}
                  >
                    17. 의제매입세액 공제신고서
                  </span>
                </p>
        ...
        <tr style={{ height: '21pt' }}>
          ...
          >
            ...
            >
              사업자등록증(사업을 폐업하고 확정신고하는 사업자의 경우에는 해당
              서류를 제출하게 하고 이를 확인)
            </p>
          </td>
        </tr>
      ...
      >
        ...
        제36조제1항에 따른 행정정보의 공동이용을 통하여 위의 담당 공무원 확인
        사항을 확인하는 것에 동의합니다. 동의하지 않는 경우에는 신고인이 직접
        관련 서류를 제출해야 합니다.
      </p>
      <p
        className="s3"
      ...
      >
        ...
        <Input
          ...
          className="focus:border-[0.5pt] focus:border-[#808080]"
          style={{
            width: '120pt',
            height: '20pt',
            border: 'none',
