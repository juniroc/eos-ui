...
export default function BusinessRegistrationForm({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h2 className="text-xl font-semibold text-gray-900 mb-6">사업자등록정보</h2>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {formData.businessCertificate ? (
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
              ...
              <p className="mt-2 text-sm text-gray-600">파일을 업로드 해주세요</p>
              <p className="mt-1 text-xs text-gray-500">(JPG, PNG, PDF, DOCX, DOC 파일만 가능합니다.)</p>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-800 focus:border-gray-800 transition-colors text-black"
          >
            <option value="" className="text-gray-500">업태를 선택해주세요</option>
        ...
        {isComplete && formData.businessCertificate && (
          <div className="flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
            ...
            <span className="text-sm text-green-800">사업자등록정보가 저장되었습니다.</span>
          </div>
        )}
      </div>
    </div>
